...
export const dados_Dados: dados_Interface = {
    usuarioAdm: {
        credencial: {
            usuario: {
                id_adm: "v8888asdfasdf"
...
export interface dados_Interface {
    usuarioAdm: {
        credencial: {
            usuario: {
                id_adm: string
...
export const modelo_Dados: modelo_Interface = {
    usuarioAdm: {
        credencial: {
            usuario: {
                id_adm: { "design": "string;", "validarSincrono": false, "validarAssincrono": false, "colecao": { "lista": false, "objeto": false } }
            ...
            , modulo: {
                id: { "design": "string;", "validarSincrono": false, "validarAssincrono": false, "colecao": { "lista": false, "objeto": false } }
                , nome: { "design": "string;", "validarSincrono": false, "validarAssincrono": false, "colecao": { "lista": false, "objeto": false } }
            ...
            , requisicao: {
                ambiente: { "design": "string;", "validarSincrono": false, "validarAssincrono": false, "colecao": { "lista": false, "objeto": false } }
        ...
        , design: {
            iniciarMenuFixo: { "design": "string;", "validarSincrono": false, "validarAssincrono": false, "colecao": { "lista": false, "objeto": false } }
        ...
        , menu: {
            adm: {
                principal: {
                    usuarioAdm: {
                        moduloNome: { "design": "string;", "validarSincrono": false, "validarAssincrono": false, "colecao": { "lista": false, "objeto": false } }
                        , url: { "design": "string;", "validarSincrono": false, "validarAssincrono": false, "colecao": { "lista": false, "objeto": false } }
...
export interface modelo_Interface {
    usuarioAdm: {
        credencial: {
            usuario: {
                id_adm: Modelo_Dados
